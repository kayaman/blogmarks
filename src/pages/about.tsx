  ...
  return (
    <AuthorLayout content={content} avatar={avatar}>
      <div>
        ...
        am a fast paced and proactive self learner. I have passion for learning new idioms,
        languages and technologies. I am a result-oriented and motivated person, and I assume
        responsibilities.
      </div>

      <div>
        I have over 20 years of programming experience, what made me become a polyglot programmer.
        Experienced technical leader. Problem solver: solid engineering foundation. Passionate about
        evangelism, research and sharing bleeding edge technologies. Experience with Basic,
        Assembler, Cobol, Pascal, C, C++, PHP, Java, JavaScript, Python, Ruby, R and others. Full
        stack and DevOps. Web development frameworks. Polyglot persistence. Deep web standards and
        HTTP knowledge. Great UNIX/Linux experience. Deep knowledge of Facebook and Google
      ...
      <div>
        ...
        new stacks I've found along the way. The list is huge. TypeScript, Zod, NextJS, Vercel,
        React, Sanity.io, Prisma, TypeORM, NestJS, Nuxt, tRPC, Vite, Vitest, Pactum, Algolia,
        Tailwind, Styled Components.. among others! And it doesn't seem to end. I would love to get
        an opportunitty to work with new stuff like this ones!
      </div>
    </AuthorLayout>
  )
}
